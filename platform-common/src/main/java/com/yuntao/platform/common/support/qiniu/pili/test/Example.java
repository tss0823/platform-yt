package com.yuntao.platform.common.support.qiniu.pili.test;
...
public class Example {
    public static void main(String[] args) {
        ...
        String accessKey = "JqyUtCXLT_ub7gNb0JCf4bBi_qgQ3hShs8eMe3SV";
        String secretKey = "gyHaG_6NIEBpje1pJDvy_nOkEHg1pUr5d-7_fSLn";
        String streamKeyPrefix = "javasdkexample" + String.valueOf(new Date().getTime());

        String hubName = "chinamons.com";  //直播空间名称
