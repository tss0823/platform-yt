...
public class Pagination<T> implements Serializable {
    ...
    @ReturnFieldComment("总共记录数量")
    private long totalCount;

    @ReturnFieldComment("总页数")
    private long pageCount;

    @ReturnFieldComment("页大小")
    private int pageSize;

    @ReturnFieldComment("第几页")
    private long pageNum;

    @ReturnFieldComment("起始数量")
    private long startRow;

    @ReturnFieldComment("结束数量")
    private long endRow;

    @ReturnClassComment("数据结果")
