package com.yuntao.platform.common.support.qiniu.pili;

import com.google.gson.Gson;
import com.yuntao.platform.common.support.qiniu.pili.utils.UrlSafeBase64;
...
public final class Stream {
    ...
    public String converts() throws PiliException {
        String path = baseUrl+"/converts";
        String json = "{\"converts\":[\"720p\",\"480p\"]}";
        try {
            String resp = cli.callWithJson(path, json);
            return resp;
        }  catch (Exception e) {
    ...
    public String snapshot(Long time) throws PiliException {
        String path = baseUrl+"/snapshot";
        String json = "{\"time\":"+time+",\"format\":\"png\"}";
        try {
            String resp = cli.callWithJson(path, json);
            return resp;
        }  catch (Exception e) {
